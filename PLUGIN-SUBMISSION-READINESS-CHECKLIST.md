...
- `[pass]` Header version and readme stable tag currently match: `0.1.3`
...
- `Version: 0.1.3` in [`plugin.php`](./plugin.php)
- `Stable tag: 0.1.3` in [`readme.txt`](./readme.txt)
...
- A release-style zip currently builds successfully at `../plugin-builds/ai-provider-for-codex-0.1.3.zip`.
