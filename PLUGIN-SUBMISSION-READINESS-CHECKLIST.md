...
Version and requirement references refreshed: 2026-07-02

## Current Status Summary

- `[pass]` Header version and readme stable tag currently match: `2.1`
...
- `Version: 2.1` in [`scriptorium-ai-provider-for-codex.php`](./scriptorium-ai-provider-for-codex.php)
- `Stable tag: 2.1` in [`readme.txt`](./readme.txt)
...
- A release-style zip currently builds successfully at `../plugin-builds/scriptorium-ai-provider-for-codex-2.1.zip`.
